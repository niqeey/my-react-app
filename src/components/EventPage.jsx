...
const EventPage = () => {
    ...
    if (Array.isArray(catDetail) && catDetail.length > 0) {
        ...
        cplist.forEach(cp => {
            // cp is like "TimeCP1", "TimeCP2", etc.
    ...
    return (
        ...
        >
            ...
            <div
                style={{
                    minHeight: 'calc(100vh - 60px)', // Reserve 60px for footer
                    width: '100%',
                    maxWidth: 1000,
                    margin: '0 auto',
                    padding: 24,
                    ...
                    >
                        ...
                        <button
                            onClick={async () => {
                                ...
                                const res = await fetch('/report/event/category/xlsx', {
                                    method: 'POST',
                                    headers: {
